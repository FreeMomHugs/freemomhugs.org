        ...
        <section class="overlay overlay-dark overlay-40 bg-gradient-dark-black" data-jarallax data-speed=".8")">
            <div class="container d-flex flex-column">
                <div class="row align-items-center justify-content-center min-vh-100 py-8 py-md-11">
                        ...
                        <!-- Brand -->
                    <div class="col-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 77.23 116.83"><defs><style>.cls-1{fill:#fff;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="_ÎÓÈ_1" data-name="—ÎÓÈ_1"><path class="cls-1" d="M47.81,116.83H29.43a2.52,2.52,0,0,1-2.51-2.51V50.66H2.51A2.51,2.51,0,0,1,0,48.15V29.78a2.51,2.51,0,0,1,2.51-2.51H26.92V2.51A2.51,2.51,0,0,1,29.43,0H47.81a2.51,2.51,0,0,1,2.51,2.51V27.27h24.4a2.51,2.51,0,0,1,2.51,2.51V48.15a2.51,2.51,0,0,1-2.51,2.51H50.32v63.66A2.52,2.52,0,0,1,47.81,116.83Zm-15.87-5H45.3V48.15a2.51,2.51,0,0,1,2.51-2.51h24.4V32.29H47.81a2.51,2.51,0,0,1-2.51-2.51V5H31.94V29.78a2.51,2.51,0,0,1-2.51,2.51H5V45.64H29.43a2.51,2.51,0,0,1,2.51,2.51Z"/></g></g></svg>
                    </div>
                    <div class="col-10 text-white mt-auto text-right mb-6">
                        <h1 class="text-light" style="font-size: 5em; font-weight: 800;">What does the Bible say about being LGBTQ+?</h1>
                        ...
                        <!-- Heading -->
                        <h2 class="text-white">
                            A common question we get from parents trying to navigate their religious beliefs and a newly
                            out LGBTQ+ child is : what does the Bible say about being LGBTQ+?
            ...
            <div class="row align-items-center justify-content-center min-vh-100 py-8 py-md-11">
                <div class="col-12 mt-auto text-left">
                    ...
                    <div class="img-fluid text-white">
                        <h2 class="text-light display-2" style="font-weight: 800;">History</h2>

                    </div>

                    <!-- Heading -->
                    <h2 class="text-white">
                        Conversion therapy is an old practice that dates back to the 1930s.
