...
1.2.2
          ...
          <!-- Button -->
          <a class="navbar-btn btn btn-sm btn-info lift ml-auto" href="https://themes.getbootstrap.com/product/landkit/" target="_blank">
    Buy now
</a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-lg-10 text-center">
            ...
            <!-- Headin -->
            <h1 class="display-1 font-weight-bold text-white" data-aos="fade-up" data-aos-delay="50">
    The UI framework that you'll actually love to use.
            ...
            <p class="mb-7 mb-md-9" data-aos="fade-up" data-aos-delay="150">
              <a class="btn btn-info shadow lift" href="#!">
                Get it now <i class="fe fe-arrow-right ml-3"></i>
              </a>
            </p>
        ...
        <div class="row">
          <div class="col-12" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="position-relative pt-7 pb-7 pl-7 mb-7 mb-md-9 rounded-xl shadow-multicolor overflow-hidden">
              ...
              <!-- Image -->
              <img class="position-relative img-fluid rounded-left shadow-lg" src="assets/img/screenshots/desktop/dashkit-alt.jpg" alt="..." />
...
We make it easy by including all of the necessary assets from fonts to illustrations to icongraphy.
            </p>
...
Beautiful style-matched illustrations for free.
                </p>
          ...
          <div class="col-12 col-sm-6 col-lg-4 mt-7">
            ...
            <div class="card h-100 bg-dark rounded-lg">
              <div class="card-body p-5 pb-0 my-auto">
                ...
                <!-- Letter -->
                <div class="line-height-1 font-weight-bolder text-info" style="font-size: 100px;">Aa</div>
              ...
              <div class="card-body p-5">
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
Hk Grotes Pro provided and licensed for all uses.
                </p>
            ...
            <div class="card h-100 bg-dark rounded-lg">
              <div class="card-body p-5 pb-0 my-auto">
                ...
                <div class="d-inline-flex flex-row-reverse">
                  <div class="p-6 rounded-circle bg-primary ml-n3"></div>
                  <div class="p-6 rounded-circle bg-gray-800 ml-n3"></div>
                  <div class="p-6 rounded-circle bg-gradient-multicolor"></div>
                </div>
...
Color Palette
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
Harmonious color scheme easy to tailor to your needs.
                </p>
            ...
            <div class="card h-100 bg-dark rounded-lg">
              <div class="card-body p-5 pb-0 my-auto">
                ...
                <div class="icon icon-xl">
                  <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"/><path d="M6 2h12a1 1 0 011 1v9a1 1 0 01-1 1H6a1 1 0 01-1-1V3a1 1 0 011-1zm1.5 3a.5.5 0 000 1h6a.5.5 0 100-1h-6zm0 2a.5.5 0 000 1h3a.5.5 0 100-1h-3z" fill="#FFFFFF" opacity="1"/><path d="M3.793 6.573L12 12.5l8.207-5.927a.5.5 0 01.793.405V17a2 2 0 01-2 2H5a2 2 0 01-2-2V6.978a.5.5 0 01.793-.405z" fill="#7C69EF"/></g></svg>
                </div>
...
Rich Iconography
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
Two sets of icons to suit any degree of fidelity.
                </p>
          ...
          <div class="col-12 col-sm-6 col-lg-4 mt-7">
            ...
            <div class="card h-100 bg-dark rounded-lg">
              <div class="card-body p-5 pb-0 my-auto">
                ...
                <!-- Images -->
                <div class="row no-gutters" style="max-width: 150px;">
                  <div class="col-4">

                    <!-- Image -->
                    <img class="w-150 rounded-sm" src="assets/img/portfolio/portfolio-3.jpg" alt="...">

                  </div>
                  <div class="col-4">

                    <!-- Image -->
                    <img class="w-150 mt-3 rounded-sm" src="assets/img/portfolio/portfolio-2.jpg" alt="...">

                  </div>
                  <div class="col-4">

                    <!-- Image -->
                    <img class="w-150 mt-5 rounded-sm" src="assets/img/portfolio/portfolio-1.jpg" alt="...">
...
Royalty Free Images
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
Collection of images to use as you please without limitation.
                </p>
...
Extensive Variables
                ...
                <!-- Text -->
                <p class="text-muted mb-0">
A rich variable system to adjust the design to your needs.
                </p>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5">
            ...
            <!-- Heading -->
            <h2 class="display-3 font-weight-bold text-white mb-6 mb-md-8">
Generate dark mode in one click.
            </h2>

            <!-- Text -->
            <p class="text-muted lead mb-6">
              <span class="text-white font-weight-bold">Considered.</span> Most frameworks simply invert colors, but we create a separate palette to make dark mode just as sharp.
            </p>

            <!-- Text -->
            <p class="text-muted lead mb-7 mb-md-0">
              <span class="text-white font-weight-bold">Efficient.</span> Often dark mode is bundled into a single style codebase, but we've kept it separate to keep filesize small.
            </p>
          ...
          <div class="col-12 col-md-6">
            ...
            <!-- Media -->
            <div class="position-relative vw-md-50 pt-7 pl-7 pl-md-9 overflow-hidden" style="max-width: 800px;">

              <!-- Background -->
              <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-gradient-multicolor rounded-xl"></div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-between">
          <div class="col-12 col-md-6 col-lg-5 order-md-1">
            ...
            <!-- Heading -->
            <h2 class="display-4 font-weight-bold text-white mb-6 mb-md-8">
              A comprenshive and organized Figma file.
            </h2>

            <!-- Text -->
            <p class="text-muted lead mb-6">
              <span class="text-white font-weight-bold">Components.</span> UI elements are organized into components and variants to make extensive customization much easier.
            </p>

            <!-- Text -->
            <p class="text-muted lead mb-7 mb-md-0">
              <span class="text-white font-weight-bold">Color + Text Styles.</span> We've codified a type scale and color palette for rapid building of new components and pages.
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-6 order-md-0">
            ...
            <div class="position-relative">
              ...
              <!-- Media -->
              <div class="position-relative vw-md-50 p-7 p-md-9 pl-0 overflow-hidden float-right" style="max-width: 800px;">

                <!-- Background -->
                <div class="position-absolute top-0 right-0 bottom-0 left-0 bg-gradient-multicolor rounded-xl"></div>

                <!-- Image -->
                <img class="position-relative w-100 w-md-120 float-right" src="assets/img/screenshots/ui/landkit-figma.png" alt="...">

              </div>

              <!-- Icon -->
              <img class="img-fluid position-absolute top-0 right-0 mt-n5 mr-n5" src="assets/img/icons/figma-dark-circle.png" alt="...">
            ...
            <div class="d-flex">
              <div class="pr-5">
                <h1 class="font-weight-bold text-white mb-0">
                  <span data-countup='{"startVal": 0}' data-to="5" data-aos data-aos-id="countup:in">0</span>k
                </h1>
              ...
              <div class="px-5">
                <h1 class="font-weight-bold text-white mb-0">
                  <span data-countup='{"startVal": 0}' data-to="17" data-aos data-aos-id="countup:in">0</span>k
                </h1>
                <p class="text-gray-700 mb-0">
                  Companies
                </p>
              ...
              <div class="pl-5">
                <h1 class="font-weight-bold text-white mb-0">
                  <span data-countup='{"startVal": "0"}' data-to="83" data-aos data-aos-id="countup:in">0</span>k
                </h1>
                <p class="text-gray-700 mb-0">
                  Apps
                </p>
...
Build your new startup the easy way.
            </h1>

            <!-- Text -->
            <p class="fs-lg text-gray-500 mb-6 mb-md-8">
Focus on the core value of your company and let us handle your UI, responsive details, and accessibility.
            </p>

            <!-- Button -->
            <a href="#!" class="btn btn-info lift">
Download a demo <i class="fe fe-arrow-right ml-2"></i>
            </a>
