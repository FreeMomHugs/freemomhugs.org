...
function wp_freemomhugs_scripts() {
	...
	//Theme CSS
    wp_enqueue_style( 'theme', get_template_directory_uri() . '/assets/front/css/theme.css',false,'1.1','all');

	//CSS Implementing Plugins
	wp_enqueue_style( 'bootstrap-icons', get_template_directory_uri() . '/assets/front/vendor/bootstrap-icons/font/bootstrap-icons.css',false,'1.1','all');
	wp_enqueue_style( 'hs-mega-menu', get_template_directory_uri() . '/assets/front/vendor/hs-mega-menu/dist/hs-mega-menu.min.css',false,'1.1','all');
	wp_enqueue_style( 'aos', get_template_directory_uri() . '/assets/front/vendor/aos/dist/aos.css',false,'1.1','all');



	// JS Global Compulsory
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/assets/front/vendor/bootstrap/dist/js/bootstrap.bundle.min.js',  1.1, true);
	// JS Implementing Plugins
	wp_enqueue_script( 'hs-header', get_template_directory_uri() . '/assets/front/vendor/hs-header/dist/hs-header.min.js',  1.1, true);
	wp_enqueue_script( 'hs-mega-menu', get_template_directory_uri() . '/assets/front/vendor/hs-mega-menu/dist/hs-mega-menu.min.js',  1.1, true);
	wp_enqueue_script( 'hs-show-animation', get_template_directory_uri() . '/assets/front/vendor/hs-show-animation/dist/hs-show-animation.min.js',  1.1, true);
	wp_enqueue_script( 'hs-go-to', get_template_directory_uri() . '/assets/front/vendor/hs-go-to/dist/hs-go-to.min.js',  1.1, true);
	wp_enqueue_script( 'aos-js', get_template_directory_uri() . '/assets/front/vendor/aos/dist/aos.js',  1.1, true);
	wp_enqueue_script( 'hs-toggle', get_template_directory_uri() . '/assets/front/vendor/hs-toggle-switch/dist/hs-toggle-switch.min.js',  1.1, true);
