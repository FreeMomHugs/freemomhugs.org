...
<div class="bg-gray-200">
    <div class="container">
        <nav class="navbar navbar-expand-lg sticky-top" aria-label="navbar" id="newsroomNavbar">
            ...
            <div class="collapse navbar-collapse" id="newsroomNavbarCollapse" style="position:relative;left: 0; top: 1rem;">
                <form class="form-inline my-4 my-md-0" action="/" method="GET">
                    <input name="s" type="text" class="py-2 h-100 mr-sm-2 form-control border-0 border-sm-1" aria-label="Search" placeholder="Search">
                    <button type="submit" class="btn btn-sm btn-outline-black py-1 h-100 mt-2 mt-md-0 ml-3">
                        Search
                    </button>
                </form>
            </div>
